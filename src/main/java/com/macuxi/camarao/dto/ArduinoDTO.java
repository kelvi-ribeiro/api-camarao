...
public class ArduinoDTO {
	...
	public ArduinoDTO(int id, String nome, String codigo, int usuarioId, String arduinoNome, int arduinoId) {
		this.id = id;
		this.nome = nome;
		this.codigo = codigo;
	...
	public static Tanque returnEntity(ArduinoDTO obj) {
